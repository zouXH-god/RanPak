...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    cloudSync: {
        ...
        refreshStatus: () => ipcRenderer.invoke('cloud-sync:refresh-status'),
        forcePull: () => ipcRenderer.invoke('cloud-sync:force-pull'),
        ...
        resolveConflicts: (ids, choice) => ipcRenderer.invoke('cloud-sync:resolve-conflicts', ids, choice),
